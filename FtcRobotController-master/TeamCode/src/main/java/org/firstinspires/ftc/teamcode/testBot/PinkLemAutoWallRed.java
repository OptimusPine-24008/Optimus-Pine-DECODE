 ...
 */
@Autonomous(name = "PinkLemAutoWallRed", group = "StarterBot")
public class PinkLemAutoWallRed extends LinearOpMode {
            ...
            switch (autoState) {
                ...
                */
                ...
                case TAG21_SPINNY_SPIN:
                    robot.turnTo((alliance == Alliance.RED) ? 47.5 : -47.0, 0.95, 0.15);//initial value 0.25
                ...
                case TAG23_SPINNY_SPIN:
                    robot.turnTo((alliance == Alliance.RED) ? 47.5 : -47.0, 0.95, 0.15);//initial valu 0.25
                ...
                case TAG22_TURN_TO_FIELD:
                    robot.turnTo((alliance == Alliance.RED) ? 0.0 : -90.0, 0.95, 0.15);
                    startIntake();
                ...
                case TAG22_BACK_TO_LAUNCHING_ZONE:
                    robot.drive(-70.0, 0.95, 0.25, 1.5);
                    //robot.turnTo((alliance == Alliance.RED) ? 43.0 : -43.0, 0.95, 0.15);
                    //shotsToFire = 4;
                    requestLaunch();
                    autoState = AutoState.TAG22_RUN_AWAY;
                    break;
                case TAG23_BACK_TO_LAUNCHING_ZONE:
                    robot.drive(-68.0, 0.95, 0.25, 1.5);
                    //robot.turnTo((alliance == Alliance.RED) ? 43.0 : -43.0, 0.95, 0.15);
                    //shotsToFire = 4;
                    requestLaunch();
                    autoState = AutoState.TAG23_RUN_AWAY;
                    break;

                case TAG22_RUN_AWAY: //Monty Python is peak lol hehehehehehe
                    robot.strafe(41, 0.95, 0.15);
                    robot.turnTo((alliance == Alliance.RED) ? 44.5 : 43.0, 0.95, 0.15);
                    autoState = AutoState.TAG22_WAIT_FOR_LAUNCH_CYCLE2;
                    break;
                case TAG23_RUN_AWAY:
                    robot.strafe(66, 0.95, 0.15);
                    robot.turnTo((alliance == Alliance.RED) ? 48.5 : 43.0, 0.95, 0.15);
                ...
                case TAG21_NOM_NOM_2:
                    //leftFeeder.setPower(-1.0);
                    //rightFeeder.setPower(-1.0);
                    robot.drive(60.0, 0.65, 0.25, 2.5);
                    //stopFeeders();
                ...
                case TAG21_NOM_NOM_3://return back to starfe to launch
                    launcher.setVelocity(LAUNCHER_TARGET_VELOCITY);
                    robot.drive(-59.0, 0.95, 0.25, 2.5);
                    // robot.strafe(-50.0, 0.95, 0.25);
                    //robot.turnTo((alliance == Alliance.RED) ? -46.0 : 45.0, 0.95, 0.15); // changed
                    //shotsToFire = 4;
                    //requestLaunch();
                    autoState = AutoState.COMPLETE; // TAG21_WAIT_FOR_LAUNCH_CYCLE3;
                    break;

                case TAG22_NOM_NOM_3://return back to starfe to launch
                    launcher.setVelocity(LAUNCHER_TARGET_VELOCITY);
                    robot.drive(59.0, 0.95, 0.25, 2.5);
                    //robot.strafe(-50.0, 0.95, 0.25);
                    //robot.turnTo((alliance == Alliance.RED) ? -46.0 : 45.0, 0.95, 0.15); // changed
