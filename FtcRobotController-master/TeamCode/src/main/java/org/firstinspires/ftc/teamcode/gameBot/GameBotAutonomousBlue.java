...
@Autonomous(name = "GameBotAutonomousBlue", group = "StarterBot")
public class GameBotAutonomousBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            switch (autoState) {
                ...
                case TAG21_TURN:
                    robot.turnTo(-40.5, 0.6, TURN_HOLD_SEC);
                    sleep(200);
                ...
                case TAG21_PULSE_BOTH:
                    ...
                    sorter.setPower(1.0);
                    robot.turnTo(-45.0, 0.6, 0.8);
                    pulseServo(rightFeeder, FEED_POS, 500);
                    sleep(100);
                    robot.turnTo(-40.5, 0.6, 0.8);
                    pulseServo(leftFeeder, FEED_POS, 500);
                ...
                case TAG21_LAUNCH_SEQUENCE:
                    ...
                    robot.turnTo(0.0, 0.6, TURN_HOLD_SEC);
                    robot.drive(-24.0, 0.6, 2.5);
                    sleep(200);
                    robot.turnTo(-90.0, 0.6, 1.1);
                ...
                case TAG21_BACK_TO_LAUNCHING_ZONE:
                    robot.turnTo(0.0, 0.6, 1.1);
                    robot.drive(24.0, 0.5, 2.0);
                    robot.turnTo(-45.0, 0.6, 0.7);
                ...
                case TAG21_WAIT_FOR_LAUNCH_CYCLE2:
                    ...
                    sleep(100);
                    sorter.setPower(-1.0);
                    robot.turnTo(-40.5, 0.6, 0.65);
                    pulseServo(leftFeeder, FEED_POS, 500);
                    sleep(150);
                    robot.turnTo(-45.0, 0.6, 0.65);
                    pulseServo(rightFeeder, FEED_POS, 500);
                    sleep(100);
                ...
                case TAG23_TURN:
                    robot.turnTo(-45.0, 0.6, TURN_HOLD_SEC);
                ...
                case TAG23_PULSE_BOTH:
                    ...
                    pulseServo(rightFeeder, FEED_POS, 500);
                    sleep(500);
                    robot.turnTo(-42.0, 0.6, TURN_HOLD_SEC);
                    pulseServo(leftFeeder, FEED_POS, 500);
                    sleep(200);
                ...
                case TAG23_WAIT_FOR_LAUNCH_CYCLE:
                    robot.turnTo(-90.0, 0.6, TURN_HOLD_SEC);
                ...
                case TAG23_WAIT_FOR_LAUNCH_CYCLE2:
                    ...
                    sleep(700);
                    spinSorter(1.0, 2000);
                    robot.turnTo(-45.0, 0.6, 0.3);
                    pulseServo(rightFeeder, FEED_POS, 500);
                    sleep(700);
                    robot.turnTo(-42.0, 0.6, 0.3);
                    pulseServo(leftFeeder, FEED_POS, 500);
                    sleep(200);
                    autoState = AutoState.ESCAPE_THE_ZONE;
                    break;
