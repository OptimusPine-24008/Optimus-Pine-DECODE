...
@Autonomous(name = "GameBotAutoRRWall", group = "StarterBot")
public class GameBotAutoRRWall extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory strafeInTrajectory = drive.trajectoryBuilder(startPose)
                .strafeLeft(110)   // same as robot.strafe(-110)
                .build();
        ...
        drive.followTrajectory(strafeInTrajectory);
        ...
        while (opModeIsActive()) {
            ...
            switch (autoState) {
                ...
                case INITIAL_DRIVE:
                    ...
                    drive.followTrajectoryAsync(strafeInTrajectory);
                ...
                case SCAN_FOR_TAG:
                    ...
                    readHuskyLensTag();    // scan every loop

                    // If we see a tag early
                    if (detectedTag != -1) {
                    ...
                    // If trajectory finished and no tag
                    if (!drive.isBusy()) {
                        autoState = AutoState.TAG_DECISION;
                    }
