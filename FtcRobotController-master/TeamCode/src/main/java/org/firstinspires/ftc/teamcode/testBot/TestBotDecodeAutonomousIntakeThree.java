 ...
 */
@Autonomous(name = "TestBotDecodeAutonomousIntake Three", group = "StarterBot")
public class TestBotDecodeAutonomousIntakeThree extends LinearOpMode {
    ...
    private static final double LAUNCHER_TARGET_VELOCITY = 1440;  // ticks/s //1350 now 1360 now 1450
        ...
        while (opModeIsActive()) {
            switch (autoState) {
                case INITIAL_DRIVE:
                    ...
                    startIntake(); // <<< NEW
                    robot.drive(-80.0, 0.7, DRIVE_HOLD_SEC);//-50.0
                ...
                case TURN_TO_FIELD:
                    ...
                    robot.turnTo(targetHeading, /*maxPower*/0.75, 0.75);
                ...
                case DRIVE_OFF_LINE:
                    ...
                    robot.drive(59, /*maxPower*/0.30, DRIVE_HOLD_SEC);//original -95.0*
                ...
                case BACK_TO_LAUNCHING_ZONE:
                    robot.drive(-58.75, /*maxPower*/0.97, 0.5); //DRIVE_HOLD_SEC
                    double targetHeading2 = (alliance == Alliance.RED) ? 0.0 : 0.0;//135.0, -135.0
                    robot.turnTo(targetHeading2, /*maxPower*/0.75, 0.75);
                ...
                case ESCAPE_THE_ZONE:
                    ...
                    robot.turnTo(targetHeading3, /*maxPower*/0.6, 0.75);
                    robot.drive(-50.0, /*maxPower*/0.75, DRIVE_HOLD_SEC);
